    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
				  ...
				  local plate = 'TABAC' .. math.random(100, 900)
            ...
            local elements = {
              {label = 'Livraison', value = 'tabac'},
              --{label = 'Livraison', value = 'youga2'},
			        {label = 'Chef Equipe', value = 'baller2'}
            }

            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              (PlayerData.job.grade_name == 'boss') then
              table.insert(elements, {label = 'Véhicule Patron', value = 'baller3'})
            end
